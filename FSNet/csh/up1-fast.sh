...
if [ $NUM_GPUS == 1 ]; then 
    ...
    CUDA_VISIBLE_DEVICES=$GPUS python3 /home/dell/csh/FSNet-master/csh/up1-fast.py --config=$CONFIG_PATH --experiment_name=$EXP_NAME $ARGS
else
    ...
    --nproc_per_node=$NUM_GPUS /home/dell/csh/FSNet-master/csh/up1-fast.py \
