...
def main(config:str="/home/dell/csh/FSNet-master/configs/nuscenes_wpose.py",
        gpu:int=0,
        checkpoint_path:str="/data/csh_test/results/workdirs2/nusc_wpose/checkpoint/monodepth.networks.models.meta_archs.monodepth2_model.MonoDepthWPose_latest.pth",
