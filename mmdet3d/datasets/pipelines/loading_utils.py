...
def load_augmented_point_cloud(path, virtual=False, reduce_beams=32):
    ...
    # print(virtual)
    # print(tokens)
    # if(tokens[2]=="nuscenes_gt_database"):
    #     # print(tokens[-2])
    #     # print(path)
    ...
    seg_path = os.path.join(
        # *tokens[:-4],
        "/data/nuscenes/virtual_points-yolov5+intensity",
        "virtual_points",
        tokens[-3],
        tokens[-2] + vp_dir,
        tokens[-1] + ".pkl.npy",
    ...
    # seg_path = '/media/dell/hdd01/nuscenes/virtual_points-MVP/virtual_points/samples/LIDAR_TOP_VIRTUAL/n008-2018-05-21-11-06-59-0400__LIDAR_TOP__1526915243047392.pcd.bin.pkl.npy'
    ...
    virtual_points1 = data_dict["virtual_points"]
    # print(virtual_points1.shape)
    # print (points.shape)
    virtual_points_add=np.concatenate([virtual_points1,points],axis=0)
    # print(virtual_points_add.shape)
    return virtual_points_add
