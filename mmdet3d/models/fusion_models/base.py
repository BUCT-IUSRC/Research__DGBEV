...
class Base3DFusionModel(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self, init_cfg=None):
        ...
        # print("Base3DFusionModel")
        nusc_root = '/data/nuscenes/nuscenes-full'
        self.nusc = NuScenes(version='v1.0-trainval', dataroot=nusc_root)
    ...
    def train_step(self, data, optimizer):
        ...
        # print("The iteration step during training")
        data['nusc'] = self.nusc
        losses = self(**data)
    ...
    def val_step(self, data, optimizer):
        ...
        """
        # print("The iteration step during validation")
        data['nusc'] = self.nusc
        losses = self(**data)
        loss, log_vars = self._parse_losses(losses)
