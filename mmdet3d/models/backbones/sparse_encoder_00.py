...
class SparseEncoder(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size, **kwargs):
        ...
        for encoder_layer in self.encoder_layers:
            ...
            # print("each sparse encoder_layer x shape")
            # print(x.dense_shape)
        # igig
        # for detection head
        # [200, 176, 5] -> [200, 176, 2]
...
if __name__=='__main__':
    spec=SparseEncoder()
    x=torch.ones((120,5))
    spec(x,coors=torch.ones((120,4)),batch_size=1)